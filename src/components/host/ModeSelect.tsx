...
/** 4a · Màn hình lớn — chọn chế độ. Màn đầu tiên chủ xị thấy sau khi mở app. */
export function ModeSelect({
  ...
  return (
    <HostFrame>
      <div className="t-title shrink-0 text-accent">BỢM SONY</div>

      <div className="flex min-h-0 flex-1 gap-5">
        <ModeCard
          active={mode === "que"}
          tone="accent"
          tag={mode === "que" ? "ĐÃ CHỌN" : "NHANH · ỒN"}
          title={
            <>
              SỐ TRỜI
              <br />
...
function ModeCard({
  ...
  return (
    ...
    >
      ...
      <div>
        <div className={`text-[60px] leading-[1.14] font-black tracking-[-0.04em] ${fg}`}>
          {title}
        </div>

...
export async function getVerdictAI(input: {
  ...
  } Phán mức uống cho người này. Trả về đúng định dạng JSON: {"dose": 100|50|25, "label": "CẠN LY"|"NỬA LY"|"NHẤP MÔI", "line": "lời phán ≤ 12 từ", "challenge": "thử thách (tuỳ chọn nếu 100%)"}`;
  ...
  if (aiResult && [100, 50, 25].includes(aiResult.dose) && aiResult.line) {
    return {
      ...
      challenge: aiResult.challenge?.trim() || undefined,
    };
  }
